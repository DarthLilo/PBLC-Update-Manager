...
class LoadingScreenCacheUpdate(QWidget):
    def __init__(self, parent=None):
        ...
        self.download_size = QLabel("0MB")
        self.download_size.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self._layout.addWidget(self.download_size)
    
    def setStatus(self,text):
        self.download_size.setText(text)