...
def grab_version_db():
    ...
    local_version_db = default_version_db #settingsMan.readSettingsValue("program","version_db")
    is_url = False
...
def grab_patch_instructions():
    ...
    local_patch_instruct = default_patch_instruct #settingsMan.readSettingsValue("program","patch_instructions")
    is_url = False
